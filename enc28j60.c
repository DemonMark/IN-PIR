...
void enc28j60Init(uint8_t* macaddr)
{
	...
	enc28j60Write(MABBIPG, 0x12); //half duplex
	...
	// enable interrutps
	enc28j60WriteOp(ENC28J60_BIT_FIELD_SET, EIE, EIE_INTIE|EIE_PKTIE|EIE_TXIE); //do³o¿one EIE_TXIE
...
void enc28j60PacketSend(uint16_t len, uint8_t* packet)
{
        ...
        while (enc28j60ReadOp(ENC28J60_READ_CTRL_REG, ECON1) & ECON1_TXRTS)
        {
                ...
                if( (enc28j60Read(EIR) & EIR_TXERIF) ) {
						...
						enc28j60WriteOp(ENC28J60_BIT_FIELD_CLR, EIR, EIR_TXERIF); //EIR_TXERIF | EIR_TXIF);
                }
        }
